# Makefile
# $Id: Makefile 18589 2014-04-25 12:29:26Z maeder $
...
logics = CASL HasCASL Isabelle Modal Alloy Hybrid TopHybrid Temporal \
...
drifted_files = Common/AS_Annotation.hs \
    CASL/AS_Basic_CASL.hs Modal/AS_Modal.hs Alloy/AS_Alloy.hs Hybrid/AS_Hybrid.hs TopHybrid/AS_TopHybrid.hs  \
...
Alloy_files = Alloy/AS_Alloy.hs Alloy/AlloySign.hs
...
Alloy/ATC_Alloy.der.hs : $(Alloy_files) $(GENRULES)
	$(GENRULECALL) -i ATC.AS_Annotation -o $@ $(Alloy_files)
